...
@endsection
@section('content')
<div class="list-title">Add khu vực</div>
...
<div class="panel-heading">Thêm khu vực </div>
<div class="panel-body">
<form action="{{route('admin.khuvuc.add')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
{{ csrf_field() }}
	<div class="form-group">
		<label class="control-label col-sm-2">Tên khu vực</label>
		<div class="col-sm-10"> 
		<input type="text" name="tenkhuvuc" class="form-control" placeholder="Tên Khu vực">
		</div>
	</div>
	<div class="form-group">
