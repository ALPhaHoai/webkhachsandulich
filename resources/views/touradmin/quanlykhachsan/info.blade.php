...
@endsection
@section('content')
<h1>Khách Sạn - Thông tin </h1>
	<form action="{!!route('admin.suakhachsaninfo')!!}" method="post" class="form-vertical" enctype="multipart/form-data" name="frmmain">
<div class="col-lg-7" >
	@if(count($errors) > 0)
	...
	<input type="hidden" name="_token" value="{{ csrf_token() }}">﻿
		...
		<div class="form-group">
			...
			<textarea class="floranote" name="thongtin" >{!! $khachsan->ThongTin!!}</textarea>
		</div>
		<div class="form-group">
